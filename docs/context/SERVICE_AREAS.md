...
> This is a partial placeholder. Drive was not accessible from the session that created
> this commit, so the full city/county/ZIP coverage table could not be pulled. Brett:
> export the **service-areas** Doc from Drive as Markdown and replace this file with the
